...
- **Q1**: It tooks me approximately 3.5 hours to complete the project.
- **Q2**: It's a interesting project to work with as snowflake is a well-known datawarehouse and I get a chance to work and play around with it.
- **Next Step**:
 - Add test cases.
